...
export async function GladiusContracts(req, res) {
    ...
    try {
        const balanceCheck = await getTokenBalance(addressBook.getContractId(network, 'token_id'), loadedConfig.getUser('PAYMENT_TOKEN_ADMIN_SECRET').publicKey(), loadedConfig.getUser('PAYMENT_TOKEN_ADMIN_SECRET'));
