...
export async function deployAndInitContracts(addressBook) {
    ...
    console.log('Deploying Gladius Coin Emitter Contract');
    console.log('-------------------------------------------------------');
    await deployContract('gladius_nft_id', 'gladius_nft', addressBook, gladius_admin);
    ...
    console.log("Using NFTInitParams=[name, symbol, admin] : ", [name, symbol, admin_public_val]);
    await invokeContract('gladius_nft_id', addressBook, 'initialize', NFTInitParams, gladius_admin);
}
